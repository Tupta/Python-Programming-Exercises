...
countyData = {}
# Umieszczenie w countyData wielkości populacji i liczby obszarów
# geograficznych spisu powszechnego.
print('Odczyt wierszy...')
for row in range(2, sheet.max_row + 1):
    # Każdy wiersz w arkuszu kalkulacyjnym zawiera dane dla jednego obszaru
    # geograficznego spisu powszechnego.
